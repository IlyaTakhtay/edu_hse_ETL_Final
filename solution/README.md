...
- Перед запуском необходимо установить все необходимые перемнные в .env файле.
- Все приведенные ниже команды приведены в файле makefile. Если нет возможности запускать через make, можно зайти в файл и выполнять docker команды самостоятельно.
  Для запуска проекта необходимо проделать шаги:
